    ...
    publications {
        bintray(MavenPublication) {
            ...
            pom {
                ...
                url = 'https://github.com/anatawa12/ForgeGradle-2.3'

                scm {
                    url = 'https://github.com/anatawa12/ForgeGradle-2.3'
                    connection = 'scm:git:git://github.com/anatawa12/ForgeGradle-2.3.git'
                    developerConnection = 'scm:git:git@github.com:anatawa12/ForgeGradle-2.3.git'
                }

                issueManagement {
                    system = 'github'
                    url = 'https://github.com/anatawa12/ForgeGradle-2.3/issues'
                }
